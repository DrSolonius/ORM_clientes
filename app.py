...
class App(ctk.CTk):
    ...
    def crear_formulario_cliente(self, parent):
        ...
        ctk.CTkLabel(frame_superior, text="Nombre").grid(row=0, column=0, pady=10, padx=8)
        self.entry_nombre = ctk.CTkEntry(frame_superior)
        self.entry_nombre.grid(row=0, column=1, pady=10, padx=8)

        ctk.CTkLabel(frame_superior, text="Email").grid(row=0, column=2, pady=10, padx=8)
        self.entry_email = ctk.CTkEntry(frame_superior)
        self.entry_email.grid(row=0, column=3, pady=10, padx=8)

        ctk.CTkLabel(frame_superior, text="Edad").grid(row=0, column=4, pady=10, padx=8)
        self.entry_edad = ctk.CTkEntry(frame_superior)
        self.entry_edad.grid(row=0, column=5, pady=10, padx=8)
    ...
    def actualizar_cliente(self):
        ...
        if not email.strip():
            ...
            return
        if not edad.strip():
            messagebox.showwarning("Campo Vacío", "Por favor, ingrese una edad.")
            return
